      ...
      <mat-card class="auth-card">
        ...
        <mat-card-content>
          ...
          <div class="social-buttons">
            <button mat-raised-button class="social-btn google-btn" (click)="signUpWithGoogle()">
            ...
            <button mat-raised-button class="social-btn github-btn" (click)="signUpWithGitHub()">
              <svg class="btn-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export class RegisterComponent {
  ...
  signUpWithGoogle(): void {
    this.socialAuthService.signUpWithGoogle();
  }

  signUpWithGitHub(): void {
    this.socialAuthService.signUpWithGitHub();
  }
